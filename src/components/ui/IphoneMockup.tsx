...
/**
 * Molde de iPhone em CSS inline puro, portado do componente de referência
 * do briefing. Já era 100% `CSSProperties`, sem Tailwind de verdade, então
 * entra quase sem alteração, só sem o wallpaper de exemplo, os projetos
 * da Atlas entram via `children` (`TelaCelularFake`).
 */
